...
function comprobarMapa(undo){
	...
	if ((teclado==movimiento.UP) && ((matriz[x-1][y] == 1) || (matriz[x-1][y] == 2) || (matriz[x-1][y] == 3))){	
			if (matriz[x-1][y] == 2){
				pastillas.cantidad--;
				matriz[x-1][y]=1
			}
	...
	if ((teclado==movimiento.DOWN) && ((matriz[x+1][y] == 1) || (matriz[x+1][y] == 2) || (matriz[x+1][y] == 3))){
			if (matriz[x+1][y] == 2){
				pastillas.cantidad--;
				matriz[x+1][y]=1
			}
	...
	if ((teclado==movimiento.LEFT) && ((matriz[x][y-1] == 1) || (matriz[x][y-1] == 2) || (matriz[x][y-1] == 3))){
			if (matriz[x][y-1] == 2){
				pastillas.cantidad--;
				matriz[x][y-1]=1
			}
		...
		for ( i=0; i< 40;i++){
			for ( v=0; v< 40;v++){
				if (matriz[i][v]==2){
					...
					numero++;
					lienzo.drawImage(pastillas.imagen,pastillas.y+30,pastillas.x+30);// el 30 es para que la imagen baje un poco
